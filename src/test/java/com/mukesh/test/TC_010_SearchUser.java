...
public class TC_010_SearchUser extends BaseTest {

    @Description("Search User by filter")
    @Test

    public void searchUser(ITestContext iTestContext)
    {
        ...
        waitJVM(30000);
       String requiredname= dashboardPage.searchByFilter(UserName);
        Assert.assertEquals(requiredname,UserName);
